...
namespace CUHK_JC_iCar_小車類 {
    ...
    function Car_run(speed1: number, speed2: number) {
       ...
       // pins.analogWritePin(AnalogPin.P1, 1023-speed); //速度控製

       // pins.analogWritePin(AnalogPin.P0, speed);//速度控製
    ...
    function Car_back(speed1: number, speed2: number) {
        ...
        //pins.analogWritePin(AnalogPin.P1, speed); //速度控製

        //pins.analogWritePin(AnalogPin.P0, 1023 - speed);//速度控製
